...
var createSignalingChannel = function(key, handlers, reset) {


var id, status, running = true, client = null,
  doNothing = function(){},
  handlers = handlers || {},
...
} //coming messages for asynchronous handling.
...
function close() {
  ...
  client1.open("POST", "/disconnect");
  var sendData = {"id":id };
  client1.send(JSON.stringify(sendData));
