	...
	public void createTable() throws Exception
	{
		try
		{
			...
			String SQL6 = "INSERT INTO `pchand_patient` (`patientid`, `patientname`, `age`, `sex`, `address`, `phone`, `weight`, `doctorid`, `disease`) VALUES"+
					"(12, 'Patient1', 45, 'male', 'bangalore', 101010101, 46, 1, 'oiokjk'),"+
					"(13, 'Patient2', 55, 'male', 'karnataka', 1234567890, 66.21, 1, 'headache'),"+
					"(14, 'Patient3', 56, 'female', 'bangalore', 2312312310, 78, 1, 'headache');";
			...
			String SQL12 = "INSERT INTO `pchand_billing` (`billno`, `patientid`, `patientname`, `doctorid`, `doctorname`, `diseasename`, `dischargedate`, `finalamount`) VALUES"+
					"(1, 12, 'patient1', 7, 'Dr.Bharadwaj', 'headache', '2016-10-29', 705.55),"+
					"(2, 13, 'patient2', 8, 'Dr.Micky Polus', 'cold', '2016-10-29', 800.69),"+
					"(3, 14, 'patient3', 9, 'Dr.Oliver Sacks', 'fever', '2016-10-30', 6000);";
			...
			String SQL14 = "INSERT INTO `pchand_appoinments` (`appoinmentid`, `patientid`, `doctorid`, `appoinmenttime`, `confirmed`) VALUES"+
					 "(7, 12, 7, '2016-12-10 10:30:00', 1),"+
					 "(8, 13, 8, '2014-12-11 12:15:00', 1),"+
					 "(9, 14, 9, '2016-12-01 10:30:15', 1);";
